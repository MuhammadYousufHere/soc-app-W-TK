 ...
 *
 * @description If the email domain of the user's email is "mod.social.com", the user will be
...
const addUser = async (req, res, next) => {
  ...
  const defaultAvatar = 'https://raw.githubusercontent.com/.jpg'
  ...
  const role = emailDomain === 'mod.social.com' ? 'moderator' : 'general'
