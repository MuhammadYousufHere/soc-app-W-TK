...
![Schema Diagram](https://raw.githubusercontent.com/MuhammadYousufHere/soc-app-W-TK/main/resources/Schema-Diagram.png)
...
Moderators have specific email domain (`@mod.social.com`). When registering with an email from this domain, the user is automatically assigned the moderator role. Moderators can be assigned to different communities from the admin dashboard.

## License

This project is licensed under the [MIT License](https://github.com/MuhammadYousufHere/soc-app-W-TK/blob/main/LICENSE).
